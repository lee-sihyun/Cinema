...
public class UserInfoServiceImpl implements UserInfoService {
	...
	public void insertUserInfo(UserInfoDTO userInfoDTO) {
		...
		userInfoDTO.setUserPw(BCrypt.hashpw(userInfoDTO.getUserPw(), BCrypt.gensalt(10)));
	...
	public void loginAuth(UserInfoDTO userInfoDTO) throws LoginAuthFailException {
		...
		System.out.println("userInfoDTO.getUserNum = " + userInfoDTO.getUserId());
		 ...
		 * throw new LoginAuthFailException(userInfoDTO.getUserId(),
	...
	public int idChk(UserInfoDTO userInfoDTO) {
		return userInfoDAO.idChk(userInfoDTO);
