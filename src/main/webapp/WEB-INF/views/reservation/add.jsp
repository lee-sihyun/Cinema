			...
			<div class="steps">
				...
				<c:forEach var="movie" items="${reSelectMv}">
					<tr>
						...
						<td><a href="reservation/add">${movie.mvName }
				...
				<c:forEach var="theater" items="${selectAddress}">
					<tr>


						<td><a href="reservation/add2">${theater.theaterName }
						<input type="hidden" value="${theater.theaterNum} ">
						</a></td>
